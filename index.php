...
<body>
        ...
        <div class="col-sm-6 text-end">
            <div id="heroCarousel" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <?php
                    $sql_hero = "SELECT * FROM gallery ORDER BY tanggal DESC";
                    $hasil_hero = $conn->query($sql_hero);
                    $first = true;
                    while ($row_hero = $hasil_hero->fetch_assoc()) {
                    ?>
                    <!-- ganti slide foto atas -->
                        <div class="carousel-item <?php if ($first) { echo 'active'; $first = false; } ?>" data-bs-interval="3000">
                            <img src="img/<?= $row_hero['gambar'] ?>" class="d-block rounded-5 transition-image mx-auto" alt="..." style="height: 300px; width: 100%; max-width: 400px; object-fit: cover;">
                        </div>
                    <?php
                    }
                    ?>
                </div>
                <!-- Optional: Add controls if desired -->
      ...
      <div class="row row-cols-1 row-cols-md-4 g-4 justify-content-center">
        <div class="col">
          <div class="card h-100">
            ...
            <ul class="list-group list-group-flush">
              ...
              <li class="list-group-item">
                Pendidikan Kewarganegaraan<br />12.30-14.10 | Kulino
              </li>
            </ul>
          </div>
        </div>
        <div class="col">
          <div class="card h-100">
            ...
            <ul class="list-group list-group-flush">
              <li class="list-group-item">
                Basis Data<br />07.00-08.40 | H.5.6
              </li>
              <li class="list-group-item">
                Sistem Operasi<br />12.30-15.00 | H.5.7
              </li>
            </ul>
          </div>
        </div>
        <div class="col">
          <div class="card h-100">
            ...
            <ul class="list-group list-group-flush">
              <li class="list-group-item">
                Probabilitas dan Statistik<br />09.30-12.00 | H.3.2
              </li>
            </ul>
          </div>
        </div>
        <div class="col">
          <div class="card h-100">
            ...
            <ul class="list-group list-group-flush">
              <li class="list-group-item">
                Logika Informatika<br />07.00-09.30 | H.4.10
              </li>
              <li class="list-group-item">
                Rekayasa Perangkat Lunak<br />12.30-15.00 | H.4.3
              </li>
            </ul>
          </div>
        </div>
        <div class="col">
          <div class="card h-100">
            ...
            <ul class="list-group list-group-flush">
              <li class="list-group-item">
                Basis Data<br />07.00-08.40 | D.2.K
              </li>
              <li class="list-group-item">
  ...
  <section id="aboutme" class="text-center p-5 bg-danger-subtle">
    <div class="container">
      <div class="d-sm-flex align-items-center justify-content-center">
        <div class="p-3">
          <img src="img/me.jpeg" class="rounded-circle border shadow" width="300" height="300" style="object-fit: cover;" />
        </div>
        <div class="p-md-5 text-sm-start">
          <h3 class="lead">A11.2024.15544</h3>
          <h1 class="fw-bold">Nashwa Harvani Rubiantono</h1>
  ...
  <footer id="footer" class="text-center p-5">
    <div>
      ...
      <a href="https://wa.me/+6288221040660"><i class="bi bi-whatsapp h2 p-2"></i></a>
    </div>
    <div>Kelompok 2 &copy; 2025</div>
  </footer>
  <!-- footer end -->
